class EnrollmentMailer < ApplicationMailer
  ...
  def enrollment_email(message)
    ...
    if Rails.env.production?
      mail(to: @message.email, bcc: ["no-reply@suncityaviationacademy.com", "info@suncityaviation.com", "georgette@suncityaviation.com"], reply_to: "info@suncityaviation.com", subject: "✈️ Application to Fly at Sun City Aviation Academy")
    else
