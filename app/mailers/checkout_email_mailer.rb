class CheckoutEmailMailer < ApplicationMailer
  ...
  def checkout_email(checkout)
    ...
    if Rails.env.production?
      mail(to: @checkout.email, bcc: ["no-reply@suncityaviationacademy.com", "info@suncityaviation.com", "georgette@suncityaviation.com"], reply_to: "info@suncityaviation.com", subject: "✈️ Your Visit to Sun City Aviation Academy")
    else
